    ...
    AIRGUITAR.slider = function() {
        $.supersized({
            ...
            slides: [ // Slideshow Images
                {
                    image: '../Assets/Public/img/slider-images/image01.jpg',
                    ...
                    image: '../Assets/Public/img/slider-images/image02.jpg',
                    ...
                    image: '../Assets/Public/img/slider-images/image03.jpg',
...
================================================== */
    ...
    AIRGUITAR.contactForm = function() {
        $("#contact-submit").on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "../Assets/Public/php/contact.php",
                data: fields,
                dataType: 'json',
    ...
    AIRGUITAR.map = function() {
        if ($('.map').length > 0) {
            ...
            $('.map').each(function(i, e) {
                ...
                var image = '../Assets/Public/img/marker.png';
...
================================================== */
    ...
    $(document).ready(function() {
        ...
        Modernizr.load([{
            ...
            nope: '../Assets/Public/js/placeholder.js',
            complete: function() {
